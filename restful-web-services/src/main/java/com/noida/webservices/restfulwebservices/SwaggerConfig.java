package com.noida.webservices.restfulwebservices;
...
public class SwaggerConfig {
	  ...
	  public static final Contact DEFAULT_CONTACT = new Contact("Aprakash", "", "");
	  public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("AP Api Documentation", "Api Documentation", "1.0", "urn:tos",
